...
| **srsRAN 4G**               | Open-source 4G software radio suite                          | [GitHub](https://github.com/srsran/srsRAN_4G) ⭐ 4,047 \| 🐛 348 \| 🌐 C++ \| 📅 2026-01-26 |
| **OpenAirInterface**        | Complete 4G/5G protocol stack                                | [Website](https://openairinterface.org/)                                                   |
| **Free5GC**                 | Open-source 5G core network implementation                   | [GitHub](https://github.com/free5gc/free5gc) ⭐ 2,348 \| 🐛 71 \| 🌐 Go \| 📅 2026-08-13    |
| **Kamailio**                | Open-source SIP server used in IMS/VoLTE labs                | [Website](https://www.kamailio.org/)                                                       |

### Configuration Guides

* **[BladeRF and YateBTS Configuration](https://github.com/Nuand/bladeRF/wiki/Setting-up-Yate-and-YateBTS-with-the-bladeRF) ⭐ 1,359 | 🐛 152 | 🌐 C | 📅 2026-08-13**
...
* **[ENISA 5G Threat Landscape](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/5g/ENISA-5G-threat-landscape.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[5GReasoner Analysis Framework](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/5g/5GReasoner.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[5G NR Jamming, Spoofing, and Sniffing](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/5g/5gjam.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[Insecure Connection Bootstrapping in Cellular Networks](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/wisec19-preprint.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[Protecting 4G and 5G Cellular Paging Protocols](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/5g/popets-2020-0008.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
...
* **[Breaking LTE on Layer Two](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/breaking-lte-layer-two.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[LTE/LTE-A Jamming, Spoofing, and Sniffing](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/LTE-jamming-magazine.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[LTE Protocol Exploits](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/LTE-security-TakeDownCon.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[Practical Attacks Against Privacy and Availability](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/Prac-4G-Attacks.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
* **[LTE Security Assessment](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/lte/LTE-open-source-HackerHalted.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21**
...
* **[VoLTE Phreaking](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/talks/HAXPO-VoLTE-Phreaking-Ralph-Moonen.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21** — Ralph Moonen
...
| srsENB          | 4G/5G Base Station Software | [GitHub](https://github.com/srsran/srsRAN/tree/master/srsenb) ⭐ 4,047 \| 🐛 348 \| 🌐 C++ \| 📅 2026-01-26 |
...
| pysim           | SIM Analysis Tool           | [GitHub](https://github.com/osmocom/pysim) ⭐ 576 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-19                     |
...
* **[CellGuard](https://github.com/seemoo-lab/CellGuard) ⭐ 415 | 🐛 3 | 🌐 Swift | 📅 2026-05-26** — SEEMOO Lab, 2024
...
* **[Bypassing GSMA SS7 Recommendations](https://github.com/W00t3k/Awesome-Cellular-Hacking/blob/master/papers/ss7/Bypassing-GSMA-SS7-Kirill-Puzankov.pdf) ⭐ 3,983 | 🐛 2 | 📅 2026-03-21** — Kirill Puzankov
