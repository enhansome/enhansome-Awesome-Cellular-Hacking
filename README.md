...
* **[Ransack](https://github.com/alphafox02/ransack) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-26** — Multi-RAT cellular survey/recon platform; unifies LTE/5G NR/GSM/NB-IoT observations from SDRs, Qualcomm phones, and Rayhunter into SQLite with REST API
...
| **srsRAN 4G**               | Open-source 4G software radio suite                          | [GitHub](https://github.com/srsran/srsRAN_4G) ⭐ 4,069 \| 🐛 349 \| 🌐 C++ \| 📅 2026-09-14 |
...
| **Open5GS**                 | Open-source 5G core and EPC implementation                   | [GitHub](https://github.com/open5gs/open5gs) ⭐ 2,720 \| 🐛 292 \| 🌐 C \| 📅 2026-09-16    |
| **Kamailio**                | Open-source SIP server used in IMS/VoLTE labs                | [Website](https://www.kamailio.org/)                                                       |

### Configuration Guides

* **[BladeRF and YateBTS Configuration](https://github.com/Nuand/bladeRF/wiki/Setting-up-Yate-and-YateBTS-with-the-bladeRF) ⭐ 1,369 | 🐛 155 | 🌐 C | 📅 2026-09-03**
...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **Ransack**               | Multi-RAT cellular survey platform for DragonOS; merges LTE/5G NR/GSM/NB-IoT into unified DB; orchestrates srsRAN, LTESniffer, FALCON, Rayhunter | [GitHub](https://github.com/alphafox02/ransack) ⭐ 4 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-26                                                    |
| **Rayhunter**             | EFF's IMSI catcher detector for Orbic hotspots; detects 2G downgrades and suspicious requests                                                    | [GitHub](https://github.com/EFForg/rayhunter) ⭐ 5,831 \| 🐛 96 \| 🌐 Rust \| 📅 2026-09-16                                                   |
...
| **CellGuard**             | iOS app detecting rogue base stations via baseband analysis                                                                                      | [GitHub](https://github.com/seemoo-lab/CellGuard) ⭐ 436 \| 🐛 1 \| 🌐 Swift \| 📅 2026-08-27                                                 |
...
| **SCAT**                  | Signaling Collection and Analysis Tool for Qualcomm/Samsung                                                                                      | [GitHub](https://github.com/fgsect/scat) ⭐ 531 \| 🐛 10 \| 🌐 Python \| 📅 2026-09-11                                                        |
...
| srsENB          | 4G/5G Base Station Software | [GitHub](https://github.com/srsran/srsRAN/tree/master/srsenb) ⭐ 4,069 \| 🐛 349 \| 🌐 C++ \| 📅 2026-09-14 |
...
* **[Rayhunter](https://github.com/EFForg/rayhunter) ⭐ 5,831 | 🐛 96 | 🌐 Rust | 📅 2026-09-16** — EFF, 2025
...
* **[CellGuard](https://github.com/seemoo-lab/CellGuard) ⭐ 436 | 🐛 1 | 🌐 Swift | 📅 2026-08-27** — SEEMOO Lab, 2024
